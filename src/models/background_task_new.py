...
class NewBackgroundTask:
    ...
    def send_email_to_employer(self, professional_id, employer_id, job_id):
        ...
        try:
            ...
            redirect_url = f"{WEB_APP_URI}/employer_dashboard/candidates?job_id={job_id}&&prof_id={professional_id}&&job_status={job_status}"
            if len(data) > 0:
    ...
    def send_email_job_apply_invite(self, professional_id, employer_id, job_id):
        ...
        try:
            ...
            if len(data) > 0:
                ...
                redirect_url = f"{WEB_APP_URI}/professional/all_jobs?job_id={job_id}&&prof_id={prof_id}&&job_status={job_status}"
                details.update({"url" : redirect_url})
    ...
    def send_plan_end_email(self, email_id):
        ...
        try:
            ...
            if len(data) > 0:
                ...
                full_name = ''
            redirect_url = f"{WEB_APP_URI}/employer_dashboard/pricing-plan"
    ...
    def delete_job_details_in_meilisearch(self, job_ids):
        """
